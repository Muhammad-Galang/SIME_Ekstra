<div class="row">
  <div class="col-md-12 col-sm-12">
    ...
    <div class="x_content">
      ...
      <form action="<?=BASEURL; ?>/Siswa/simpanSiswa" method="post" enctype="multipart/form-data">

        <!-- <span class="section">Personal Info</span> -->
        <div class="field item form-group">
          <label class="col-form-label col-md-3 col-sm-3 label-align">Id Memilih Ekskul<span class="required">*</span></label>
          <div class="col-md-6 col-sm-6">
            <input class="form-control" name="id_memilih_ekskul" type="number" ></div>
          </div>

          <div class="field item form-group">
            <label class="col-form-label col-md-3 col-sm-3  label-align">Id Pengguna<span class="required">*</span></label>
            <div class="col-md-6 col-sm-6">
              <input class="form-control" type="date" name="id_pengguna" required='required'></div>
            </div>

            <div class="field item form-group">
              <label class="col-form-label col-md-3 col-sm-3  label-align">Id Ekskul<span class="required">*</span></label>
              <div class="col-md-6 col-sm-6">
                <input class="form-control" name="id_ekskul" required="required" type="number"></div>
              </div>
              ...
              <div class="field item form-group">
                ...
                <div class="field item form-group">
                  ...
                  <div class="col-md-6 col-sm-6">
                    <input class="form-control" name="tanggal_terdata" required="required" type="number"></div>
                  </div>
