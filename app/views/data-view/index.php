            ...
            <tbody>
              <?php foreach ($data['usr'] as $dtUser) : ?>
                <tr>
                  ...
                  <td>
                    <a href="<?=BASEURL; ?>/user/hapus/<?=$dtUser['Id_pengguna']; ?>" onclick="return confirm('yakin?')";><button type="button" class="btn btn-danger">Hapus</button></a>

                    <a href="<?=BASEURL; ?>/user/edit/<?=$dtUser['Id_pengguna']; ?>" ><button type="button" class="btn btn-warning">Edit</button></a>
                  </td>
                </tr>
              <?php endforeach; ?>
            </tbody>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="foto_profil" autocomplete="off" name="foto_profil">
      </div>
