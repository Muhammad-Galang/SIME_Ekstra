+<div class="row">
  <div class="col-md-12 col-sm-12">
    ...
    <div class="x_content">
      <form action="<?=BASEURL; ?>/Ekstrakurikuler/simpanEkstrakurikuler" method="post" enctype="multipart/form-data">
