...
<head>
    ...
    <link rel="stylesheet" href="<?= BASEURL; ?>/landing-page/dist/css/style.css">
    <script src="<?= BASEURL; ?>/landing-page/dist/js/scrollreveal.min.js"></script>
</head>
            ...
            <section class="hero text-light text-center">
                <div class="container-sm">
                    <div class="hero-inner">
                        <h1 class="hero-title h2-mobile mt-0 is-revealing">Selamat datang di website ekstrakurikuler kami!</h1>
                        <p class="hero-paragraph is-revealing">Temukan beragam      kegiatan dan peluang ekstrakurikuler yang menarik di sini.   Bergabunglah dengan kami untuk mengembangkan minat,    bakat, dan keterampilan Anda di luar kurikulum      utama.</p>
                    </p>
                </div>
            </div>
        </section>
    ...
    <section class="features section text-center">
        <div class="container">
            <div class="features-inner section-inner has-top-divider">
                <h2 class="section-title mt-0">Temukan Ektrakurikuler Mu___</h2>
                <div class="features-wrap">

                    <div class="feature is-revealing">
                        <div class="feature-inner">
                            <div class="feature-icon">
                                <img src="<?= BASEURL; ?>/image/Pramuka.jpg">
                            </div>
                    ...
                    <div class="feature is-revealing">
                        <div class="feature-inner">
                            <div class="feature-icon">
                                <img src="<?= BASEURL; ?>/image/English_Club.jpg">
                            </div>
                            <h4 class="feature-title h3-mobile">English Club</h4>
                            <a href="<?= BASEURL; ?>/Home/JoinEkskulPramuka"> 
                                <button class="button button-sm button-shadow" > . . . </button>
                            </a>
                        </div>
                    ...
                    <div class="feature is-revealing">
                        <div class="feature-inner">
                            <div class="feature-icon">
                                <img src="<?= BASEURL; ?>/image/Marsing_Band.jpg">
                            </div>
                            <h4 class="feature-title h3-mobile">Marsing Band</h4>
                            <a href="<?= BASEURL; ?>/Home/JoinEkskulPramuka"> 
                                <button class="button button-sm button-shadow" > . . . </button>
                            </a>
                        </div>
                    ...
                    <div class="feature is-revealing">
                        <div class="feature-inner">
                            <div class="feature-icon">
                                <img src="<?= BASEURL; ?>/image/Pemanah.jpg">
                            </div>
                            <h4 class="feature-title h3-mobile">Memanah</h4>
                            <a href="<?= BASEURL; ?>/Home/JoinEkskulPramuka"> 
                                <button class="button button-sm button-shadow" > . . . </button>
                            </a>
                        </div>
                    ...
                    <div class="feature is-revealing">
                        <div class="feature-inner">
                            <div class="feature-icon">
                                <img src="<?= BASEURL; ?>/image/Tari_tradisional.jpg">
                            </div>
                            <h4 class="feature-title h3-mobile">Tari Tradisional</h4>
                            <a href="<?= BASEURL; ?>/Home/JoinEkskulPramuka"> 
                                <button class="button button-sm button-shadow" > . . . </button>
                            </a>
                        </div>
                    ...
                    <div class="feature is-revealing">
                        <div class="feature-inner">
                            <div class="feature-icon">
                                <img src="<?= BASEURL; ?>/image/Voli_Ball.jpg">
                            </div>
                            <h4 class="feature-title h3-mobile"> Voli </h4>
                            <a href="<?= BASEURL; ?>/Home/JoinEkskulPramuka"> 
                                <button class="button button-sm button-shadow" > . . . </button>
                            </a>
                        </div>
...
<script src="<?= BASEURL; ?>/landing-page/dist/js/main.min.js"></script>
</body>
</html>
