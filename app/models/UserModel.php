...
class UserModel {
    ...
    $this->db->bind('Foto_Profil', $data['foto_profil']); // Menambahkan pengikatan untuk 'Foto_Profil'
    $this->db->bind('Level_Pengguna', $data['level_pengguna']);
    $this->db->bind('Kelas', $data['kelas']);
    $this->db->bind('Alamat', $data['alamat']);
    $this->db->bind('Kata_Sandi', $data['kata_sandi']);
    $this->db->bind('Id_pengguna', $data['id_pengguna']); // Pastikan Anda ikat Id_pengguna
